							...
							<div class="module-body">
									<form class="form-horizontal row-fluid">
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="basicinput" class="span8" name="username">
											</div>
										</div>
										<div class="control-group">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="basicinput" class="span8" name="nip"/>
											</div>
										</div>
										<div class="control-group">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="date" id="basicinput" class="span8" name="tanggal_masuk"/>
											</div>
										</div>
										<div class="control-group">
										...
										<div class="control-group">
											<a class="btn btn-large btn-standard">Tambah User</a>
										</div>
						</div>
					</div><!--/.content-->
				</div><!--/.span9-->
