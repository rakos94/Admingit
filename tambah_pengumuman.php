							...
							<div class="module-body">
									<form class="form-horizontal row-fluid">
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="basicinput" class="span8" name="judul">
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">Isi Pengumuman</label>
											<div class="controls">
												<textarea class="span8" rows="12"name="isi"></textarea>
											</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">Tanggal Posting</label>
											<div class="controls">
												<input type="date" id="basicinput" class="span8" name="tanggal_posting">
											</div>
											<br><br>
										<div class="control-group">
											<a class="btn btn-large btn-standard">Tambah Pengumuman</a>
										</div>
						</div>
					</div><!--/.content-->
				</div><!--/.span9-->
