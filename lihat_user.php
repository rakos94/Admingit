							...
							<div class="module-body">
									<form class="form-horizontal row-fluid">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="password" id="basicinput" class="span8" name="password"disabled>
											</div>
											<br><br>
										<div class="module-head">
											<h3>Data Diri</h3>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="basicinput" class="span8" name="nama"disabled>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">Gelar Depan</label>
											<div class="controls">
												<input type="text" id="basicinput" class="span8" name="gelar_depan"disabled>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">Gelar Belakang</label>
											<div class="controls">
												<input type="text" id="basicinput" class="span8" name="gelar_belakang"disabled>
											</div>
										</div>	
										<div class="control-group">
											<label class="control-label" for="basicinput">Kewarganegaraan</label>
											<div class="controls">
												<select tabindex="1" class="span8" name="kewarganegaraan"disabled>
										...
										<div class="control-group">
											...
											<div class="controls">
												<select tabindex="1" class="span8" name="jenis_kelamin"disabled>
													<option value="">Pilih Disini...</option>
										...
										<div class="control-group">
											...
											<div class="controls">
												<select tabindex="1" class="span8" name="agama"disabled>
													<option value="">Pilih Disini...</option>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="basicinput" class="span8" name="tempat_lahir"disabled>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">Tanggal Lahir</label>
											<div class="controls">
												<input type="date" id="basicinput" class="span8" name="tanggal_lahir"disabled>
											</div>
										</div>
										<div class="control-group">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="basicinput" class="span8" name="alamat"disabled>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">Kabupaten/Kota</label>
											<div class="controls">
												<select tabindex="1" class="span8" name="kabupatenKota"disabled>
													<option value="">Pilih Disini...</option>
										...
										<div class="control-group">
											...
											<div class="controls">
												<select tabindex="1" class="span8" name="provinsi"disabled>
													<option value="">Pilih Disini...</option>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="basicinput" class="span8" name="telepon" disabled />
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">HP</label>
											<div class="controls">
												<input type="text" id="basicinput" class="span8" name="hp"disabled />
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">Email</label>
											<div class="controls">
												<input type="text" id="basicinput" class="span8" name="email"disabled />
											</div>
										</div>
										<br><br>
										<div class="module-head">
										...
										<div class="control-group">
											...
											<div class="controls">
												<select tabindex="1" class="span8" name="divisi"disabled>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="basicinput" class="span8" name="jabatan" disabled />
											</div>
										</div>
										<div class="control-group">
										...
										<div class="control-group">
											...
											<div class="controls">
												<select tabindex="1" class="span8" name="jenjang_pendidikan"disabled>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="basicinput" class="span8" name="prodi" disabled />
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">Status Karyawan</label>
											<div class="controls">
												<input type="text" id="basicinput" class="span8" name="status_karyawan"disabled />
											</div>
										</div>
										<div class="control-group">
											<a href="edit_user.php" class="btn btn-large btn-standard">Edit</a>
										</div>
						</div>
					</div><!--/.content-->
				</div><!--/.span9-->
