							...
							<div class="module-body">
									<form class="form-horizontal row-fluid">
										...
										<div class="control-group">
											...
											<div class="controls">
												<select tabindex="1" class="span8" name="bulan_kerja">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="basicinput" class="span8" name="jumlah_hari_aktif">
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">Jumlah Masuk</label>
											<div class="controls">
												<input type="text" id="basicinput" class="span8" name="jumlah_kehadiran">
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">Jumlah Jam Lembur</label>
											<div class="controls">
												<input type="text" id="basicinput" class="span8" name="jumlah_jam_lembur">
											</div>
										</div>	
										<div class="control-group">
											<label class="control-label" for="basicinput">Gaji Pokok</label>
											<div class="controls">
												<input type="text" id="basicinput" class="span8" name="gaji_pokok">
											</div>
										</div>	
										<div class="control-group">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="basicinput" class="span8" name="total_gaji">
											</div>
										</div>	
										<div class="control-group">
